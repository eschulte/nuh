...
2) [Strategic Principles](#ii.-strategic-principles)
3) [Five Key Ingredients](#iii.-five-key-ingredients)
...
1.  [**Teams**](#teams) - teams of indigenous organizers
2.	[**Bases**](#bases) - bases of operations
3.	[**Networks**](#networks) - mutual support networks
4.	[**Voices**](#voices) - lines of communication
5.	[**Cores**](#cores) - connected cores of leaders trained in political consciousness and strategy
...
<div style="text-align: center;">Originally Published by the Annie Smart Leadership Development Institute, 1999. Adapted from the University of the Poor's <a href=https://universityofthepoor.org/poor-organizing-the-poor-resource-center>Poor Organizing the Poor Resource Center</a>.</div>
